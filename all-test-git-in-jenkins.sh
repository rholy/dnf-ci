...
cp dnf-ci/dnf-git2rpm.sh dnf-ci/dnf-git2src-in-mock.sh dnf-ci/dnf-make-spec-in-mock.sh dnf-ci/dnf-make-spec.cmake dnf-ci/dnf-edit-spec.sh dnf-ci/srpm2rpm-with-deps.sh dnf
